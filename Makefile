...
INC = -Iinclude -ItestClasses
CFLAGS = -Wall -fexceptions
RESINC = 
LIBDIR = 
LIB = /usr/lib/libgtest_main.a /usr/lib/libgtest.a
LDFLAGS = -pthread

INC_DEBUG = $(INC) -ItestClasses
...
DEP_DEBUG = 
OUT_DEBUG = bin/Debug/camCompiler

INC_RELEASE = $(INC) -ItestClasses
...
DEP_RELEASE = 
OUT_RELEASE = bin/Release/camCompiler
